...
y_array <- reshape_y_pred(ewmv_ppc_fit, "y_pred", stan_data_ppc$nsub, stan_data_ppc$ntrial, stan_data_ppc$maxpump)
draws_total_pumps <- apply(y_array, c(1, 2, 3), function(x) sum(x == 1, na.rm = TRUE))
