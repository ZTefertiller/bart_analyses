...
stan_data <- create_stl_stan_params(df)
```
...
```{r looic}
post <- rstan::extract(beta_test_2)

log_lik_array <- extract(beta_test_2, pars = "log_lik")$log_lik  # now dim = (iterations, nsub, ntrial)
